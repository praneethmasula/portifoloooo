...
@Component({
  selector: 'app-animationscrolldirective',
  templateUrl: './animationscrolldirective.component.html',
  styleUrls: ['./animationscrolldirective.component.css']
})
export class AnimationscrolldirectiveComponent {
